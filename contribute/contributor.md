...
> [!ATTENTION] **请勿按原样复制文中的命令**，实际的用户名和电子邮件地址请替换成自己的，因按原样复制导致的严重后果与作者无关。（具体原因参照[一个贴吧帖子](https://tieba.baidu.com/p/9286101504)） 与此同时查看[此处的文本](https://tie-guo.github.io/TPhi-Editor-Docs/reference/Montelli-Error.txt)
> 
